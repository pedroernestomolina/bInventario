...
namespace ILibInventario
{
    ...
    public interface IProducto
    {
        ...
        DtoLib.ResultadoLista<DtoLibInventario.Producto.Resumen> 
            Producto_GetLista(DtoLibInventario.Producto.Filtro filtro);
        DtoLib.ResultadoEntidad<DtoLibInventario.Producto.VerData.Ficha> 
            Producto_GetFicha(string autoPrd);
        DtoLib.ResultadoEntidad<DtoLibInventario.Producto.VerData.Identificacion> 
            Producto_GetIdentificacion(string autoPrd);
        DtoLib.ResultadoEntidad<DtoLibInventario.Producto.VerData.Existencia>
        ...
        DtoLib.ResultadoEntidad<DtoLibInventario.Producto.Depositos.Ver.Ficha> 
